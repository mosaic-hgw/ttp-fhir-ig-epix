# Parameters-AddPatient-response-example-1 - v2026.2.0-rc
...
* **Parameters-AddPatient-response-example-1**

## Example Parameters: Parameters-AddPatient-response-example-1
...
```json
{
  ...
  "id" : "Parameters-AddPatient-response-example-1",
  "parameter" : [{
    "name" : "matchResult",
    "part" : [{
      "name" : "sourceIdentity",
