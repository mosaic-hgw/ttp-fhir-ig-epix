...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Person/f:name/f:prefix</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Person/f:name/f:prefix/f:extension</sch:title>
    <sch:rule context="f:Person/f:name/f:prefix/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Person/f:managingOrganization</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Person/f:managingOrganization/f:identifier</sch:title>
    <sch:rule context="f:Person/f:managingOrganization/f:identifier">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Person/f:link/f:target</sch:title>
