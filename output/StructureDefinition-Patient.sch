...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://ths-greifswald.de/fhir/StructureDefinition/epix/CustomIdatValues']) &lt;= 1">extension with URL = 'https://ths-greifswald.de/fhir/StructureDefinition/epix/CustomIdatValues': maximum cardinality of 'extension' is 1</sch:assert>
