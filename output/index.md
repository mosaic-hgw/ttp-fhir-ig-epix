...
```json
{
  ...
  "status" : "active",
  "date" : "2026-09-17T16:38:22+02:00",
  ...
  "packageId" : "ths-greifswald.ttp-fhir-gw.epix",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://ths-greifswald.de/fhir/epix/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      "name" : "Beispiel-Instanz für MatchParametersProfile AddPossibleMatchForIdentity",
      "description" : "Eine konkrete Instanz des MatchParametersProfile mit Beispielwerten.",
      "exampleCanonical" : "https://ths-greifswald.de/fhir/StructureDefinition/epix/MatchParametersProfile"
    },
    {
      ...
      "name" : "Beispiel-Instanz für MatchParametersProfile AddPossibleMatchForPerson",
      "description" : "Eine konkrete Instanz des MatchParametersProfile mit Beispielwerten.",
      "exampleCanonical" : "https://ths-greifswald.de/fhir/StructureDefinition/epix/MatchParametersProfile"
    },
    {
    ...
    },
    {
      ...
      "name" : "OperationOutcome-AssignIdentity-response-example-1",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "name" : "OperationOutcome-RemovePossibleMatches-response-example-1",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "name" : "Parameters-AddPatient-request-example-1",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "name" : "Parameters-AddPatient-response-example-1",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
    ...
    },
    {
      ...
      "name" : "Parameters-AssignIdentity-request-example-1",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
    ...
    },
    {
      ...
      "name" : "Parameters-RemovePossibleMatches-request-example-1",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "name" : "Parameters-SetReferenceIdentity-request-example-1",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "name" : "Parameters-SetReferenceIdentity-response-example-1",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "name" : "Parameters-UpdatePatient-request-example-1",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "name" : "Parameters-UpdatePatient-response-example-1",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
    ...
    },
    {
      ...
      "exampleCanonical" : "https://ths-greifswald.de/fhir/StructureDefinition/epix/Person"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    "page" : {
      ...
      },
      {
        ...
        "nameUrl" : "Suche.html",
        "title" : "Suche nach Personen und Identitäten",
        "generation" : "markdown"
      },
      {
        "extension" : [{
